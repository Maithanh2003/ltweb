			...
			<form action="" id="manage_user">
				...
				<div class="row">
						...
						<?php if ($_SESSION['login_type'] == 1): ?>
							<div class="form-group">
								...
								<select name="type" id="type" class="custom-select custom-select-sm">
									<option value="3" <?php echo isset($type) && $type == 3 ? 'selected' : '' ?>>nhân viên
									</option>
									<option value="2" <?php echo isset($type) && $type == 2 ? 'selected' : '' ?>>quản lí
									</option>
									<option value="1" <?php echo isset($type) && $type == 1 ? 'selected' : '' ?>>quản trị
									</option>
								</select>
							</div>
						<?php else: ?>
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<label class="control-label">mật khảu</label>
							<input type="password" class="form-control form-control-sm" name="password" <?php echo !isset($id) ? "required" : '' ?>>
							<small><i><?php echo isset($id) ? "để trống nếu không muốn thay đổi" : '' ?></i></small>
						</div>
						<div class="form-group">
				...
				<div class="col-lg-12 text-right justify-content-center d-flex">
					...
					<button class="btn btn-secondary" type="button"
						onclick="location.href = 'index.php?page=user_list'">huỷ</button>
				</div>
			</form>
		</div>
	</div>
