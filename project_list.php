			...
			<?php if ($_SESSION['login_type'] != 3): ?>
				<div class="card-tools">
					<a class="btn btn-block btn-sm btn-default btn-flat border-primary"
						href="./index.php?page=new_project"><i class="fa fa-plus"></i> Thêm dự án</a>
				</div>
			<?php endif; ?>
		</div>
		<div class="card-body">
							...
							<td class="text-center">
								...
								<div class="dropdown-menu" style="">
									<a class="dropdown-item view_project"
										...
										data-id="<?php echo $row['id'] ?>">xem</a>
									<div class="dropdown-divider"></div>
									<?php if ($_SESSION['login_type'] != 3): ?>
										<a class="dropdown-item"
											href="./index.php?page=edit_project&id=<?php echo $row['id'] ?>">sửa</a>
										<div class="dropdown-divider"></div>
...
<script>
	$(document).ready(function () {
		...
		$('.delete_project').click(function () {
			_conf("Bạn có chắc muốn xoá?", "delete_project", [$(this).attr('data-id')])
		})
	})
