...
<div class="col-lg-12">
						...
						<div class="col-md-6">
							...
							<dl>
								...
								<dd>
									...
									<?php else: ?>
										<small><i>Xoá thành công</i></small>
									<?php endif; ?>
								</dd>
							</dl>
						</div>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<b>Hoạt động của thành viên</b>
					<div class="card-tools">
						<button class="btn btn-primary bg-gradient-primary btn-sm" type="button"
							id="new_productivity"><i class="fa fa-plus"></i> sản phẩm mới</button>
					</div>
				</div>
				<div class="card-body">
					<?php
...
<script>
	$('#new_task').click(function () {
		uni_modal("New Task For <?php echo ucwords($name) ?>","manage_t              ask.php?pid=<?php echo $id ?>","mid-large")
	})
